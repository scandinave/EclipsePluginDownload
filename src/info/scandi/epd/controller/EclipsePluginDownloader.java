	...
	private void downloadPlugins() throws IOException {
		...
		for (String pluginName : pluginNames) {
			...
			do {
				...
				StringBuilder command = new StringBuilder(ECLIPSECPATH
				...
				this.executeCommand(command.toString().replace("metadata", "artifact"));
